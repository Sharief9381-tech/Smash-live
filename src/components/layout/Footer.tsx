        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-slate-500 font-medium max-w-sm leading-relaxed">
              The world's most advanced badminton analytics and live scoring ecosystem. Empowing players, fans, and organizers with real-time intelligence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/player/1" className="text-slate-500 hover:text-sky-500 font-medium transition-colors">Player Stats</Link></li>
              <li><Link to="#" className="text-slate-500 hover:text-sky-500 font-medium transition-colors">Global Rankings</Link></li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="font-black text-[#0B1F3A] uppercase tracking-widest text-sm mb-6">Get the App</h4>
