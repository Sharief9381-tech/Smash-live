...
const TournamentSection = () => {
  return (
    <div className="py-32 text-center bg-white rounded-[3.5rem] border-2 border-dashed border-slate-100">
      ...
      <p className="text-sm font-black text-slate-400 uppercase tracking-widest mt-2 italic">Register for tournaments in the 'Tournaments' tab to begin your career log.</p>
    </div>
  );
};
