...
const Rankings = () => {
  ...
  const filteredRankings = useMemo(() => {
    ...
    // Inject current user if they match the scope
    if (userProfile) {
      const userEntry = {
        id: 999,
        rank: 1, // Assume rank 1 for demo
      ...
      // Check if user is already in the list (Viktor)
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredRankings.length > 0 ? filteredRankings.map((row, idx) => (
                      <TableRow key={row.id} className={cn("border-slate-100 hover:bg-slate-50/50 transition-colors group h-24", row.isUser && "bg-sky-50/30")}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <h4 className="font-black text-[#0B1F3A] group-hover:text-sky-600 transition-colors text-base">
                      ...
                      <TableRow>
                        <TableCell colSpan={7} className="h-64 text-center">
                          <div className="flex flex-col items-center justify-center space-y-4">
                            ...
                            <div>
                              <p className="font-black text-[#0B1F3A] uppercase tracking-widest">No intelligence found</p>
                              <p className="text-xs text-slate-400 font-medium">No players are currently registered in this {scope}.</p>
                            </div>
                          </div>
                        </TableCell>
                      </TableRow>
